...
import com.kottapa.youtubedemo.overview.ApiStatus
import com.kottapa.youtubedemo.overview.PhotoGridAdapter

/**
 * When there is no Item data (data is null), hide the [RecyclerView], otherwise show it.
 */
